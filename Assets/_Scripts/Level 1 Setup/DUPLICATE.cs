...
//    private float[] stRadii = { 4, 2.5f, 1.5f };
//    private float[] ctSizes = { 7, 4, 2 }; 
//    public int[] tSpacings = { 3, 2, 1 };
//    public int[] tHeight1s = { 15, 20, 25 }; 
//    public int[] tHeight2s = { 45, 40, 40 }; 
//    public int[] z1s = { -15, -10, -5 };
//    public int[] z2s = { 15, 10, 5 }; 
