...
//{
//    // two prefab arrays, settable from the editor
//    public GameObject[] sTargets = new GameObject[3]; 
//    public GameObject[] cTargets = new GameObject[3]; 


//    private float[] sphereRadiiPerLevel = { 4, 2.5f, 1.5f };  
//    private float[] cubeSizePerLevel = { 7, 4, 2 };
//    public int[] spaceBetweenTargetsPerFirst3Levels = { 3, 2, 1 };
//    public int[] targetHeight1PerHorizontalLevel = { 15, 20, 25 }; 
//    public int[] targetHeight2PerHorizontalLevel = { 45, 40, 40 }; 
//    public int[] targetXPos1PerVerticalLevel = { -15, -10, -5 };
//    public int[] targetXPos2PerVerticalLevel = { 15, 10, 5 }; 
//    public int[] anglesBetweenTargetsPerCircularLevel= { 30, 24, 18 };
//    public int[] radiiLengthFromCenterPerCircularLevel = { 25, 20, 15 };
